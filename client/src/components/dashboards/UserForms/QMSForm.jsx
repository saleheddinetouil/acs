<<<<<<< HEAD
<<<<<<<< HEAD:client/src/components/dashboards/UserForms/QMSForm.jsx
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (formSubmissionId) {
        // Update existing form submission
<<<<<<< HEAD
        await axios.put(`/user/update-form/${formSubmissionId}`, { formData }, {
=======
        await axios.put(`/user/update-form/${formSubmissionId}`, { userId:user._id, formData }, {
>>>>>>> 3c7052bbbc28fc4fe45250b694ba767724b453e8
          headers: Auth.authHeader(),
...
<<<<<<< HEAD
>>>>>>>> 3c7052bbbc28fc4fe45250b694ba767724b453e8:client/src/components/UserForms/QMSForm.jsx
=======
>>>>>>> 3c7052bbbc28fc4fe45250b694ba767724b453e8
